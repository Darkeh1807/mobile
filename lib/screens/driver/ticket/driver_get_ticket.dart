...
class DriversTicketDetailsScreen extends StatefulWidget {
  final String bookingId;
  const DriversTicketDetailsScreen({super.key, required this.bookingId});

  @override
  State<DriversTicketDetailsScreen> createState() => _DriversTicketDetailsScreenState();
}

class _DriversTicketDetailsScreenState extends State<DriversTicketDetailsScreen> {
  bool isLoading = true;
