...
class Trip {
  ...
  factory Trip.fromJson(Map<dynamic, dynamic> json) => Trip(
        ...
        busCompany: json["busCompany"] == null
            ? null
            : BusCompany.fromJson(json["busCompany"]),
        ...
        updatedAt: json["updatedAt"] == null
            ...
            : DateTime.parse(json["updatedAt"]),
        v: json["__v"],
        timeScheduled: json["timeScheduled"] == null
            ? null
            : TimeScheduled.fromJson(json["timeScheduled"]),
      );
...
class BusCompany {
  ...
  factory BusCompany.fromJson(Map<dynamic, dynamic> json) => BusCompany(
        ...
        buses: json["Buses"] == null
            ? []
            : List<String>.from(json["Buses"]!.map((x) => x)),
        drivers: json["Drivers"] == null
            ? []
            : List<String>.from(json["Drivers"]!.map((x) => x)),
        trips: json["Trips"] == null
            ? []
            : List<dynamic>.from(json["Trips"]!.map((x) => x)),
  ...
  Map<dynamic, dynamic> toJson() => {
        ...
        "Drivers":
            drivers == null ? [] : List<dynamic>.from(drivers!.map((x) => x)),
